...
<html lang="en">
    <head>
        ...
        <title>RAMP - Game Rentals (Playstation)</title>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item active" href="playstation.php">Playstation</a></li>
                            </ul>
                        </li>
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <?php
                        ...
                        curl_setopt_array($curl, [
                            ...
                            CURLOPT_POSTFIELDS => 'fields name,category,platforms,cover.url; where category = 0 & platforms = {48,167}; limit 100; sort rating desc;',
                        ]);
